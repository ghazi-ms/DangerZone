...
class Cards extends StatefulWidget {
  ...
  Cards(this.historyList, this.dataList, {super.key});
            ...
            child: SingleChildScrollView(
              ...
              Column(children: [
                ...
                NewsCards(
                  ...
                  description: "وأوضح المصدر أن وزارة المياه والري لا تستطيع اقامة سدود في المناطق الشرقية نظرا لطبيعة تلك المناطق، حيث أن الأرض مستوية ورملية، ولا يوجد بها جبال وأودية يمكن تصميم سدود بها، لافتا إلى أن الوزارة تقوم بعمل مشاريع حصاد مائي من خلال الحفائر والسدود الترابية في تلك المناطق.".length.toString(),
                  timestamp: DateTime.now().toString(),
                  coo: const [45884.184, 84654.4684],
                ),
                NewsCards(
                ...
                NewsCards(
                  ...
                  description: "دعا الديوان بالتنسيق مع مختلف المؤسسات والوزارات إلى تعبئة شواغر مختلفة استنادا للشروط المنصوص عليها من كل مؤسسة. ".length.toString(),
                  timestamp: DateTime.now().toString(),
                  coo: const [45884.184, 84654.4684],
                ),
              ],
